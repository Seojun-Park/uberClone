        ...
        <>
          ...
          <S.Buttons>
            {ride.status !== StatusOptions.ONROUTE && isDriver && (
              <S.CancelButton type="button" onClick={() => onDriverButton(StatusOptions.FINISHED)} value="Finish" bgColor="green" />
            )}
            {ride.status !== StatusOptions.ONROUTE && !isDriver && (
              <S.CancelButton type="button" onClick={() => onDriverButton(StatusOptions.CANCELED)} value="Cancel" bgColor="red" />
            )}
          </S.Buttons>
        </>
      )}
